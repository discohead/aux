...
public struct SearchSongsCommand: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "songs",
        abstract: "Search for songs in the Apple Music catalog"
    )
    ...
    public func run() async throws {
        ...
        do {
            ...
            try await SearchSongsHandler.handle(services: services, options: options, query: query, limit: limit, offset: offset)
        } catch {
