...
public struct SearchCuratorsCommand: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "curators",
        abstract: "Search for curators in the Apple Music catalog"
    )
    ...
    public func run() async throws {
        ...
        try await SearchCuratorsHandler.handle(services: services, options: options, query: query, limit: limit, offset: offset)
    }
    public init() {}
}
