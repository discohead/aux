...
public struct SearchStationsCommand: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "stations",
        abstract: "Search for stations in the Apple Music catalog"
    )
    ...
    public func run() async throws {
        ...
        do {
            ...
            try await SearchStationsHandler.handle(services: services, options: options, query: query, limit: limit, offset: offset)
        } catch {
