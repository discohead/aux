...
public struct SearchPlaylistsCommand: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "playlists",
        abstract: "Search for playlists in the Apple Music catalog"
    )
    ...
    public func run() async throws {
        ...
        do {
            ...
            try await SearchPlaylistsHandler.handle(services: services, options: options, query: query, limit: limit, offset: offset)
        } catch {
