...
public struct SearchArtistsCommand: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "artists",
        abstract: "Search for artists in the Apple Music catalog"
    )
    ...
    public func run() async throws {
        ...
        do {
            ...
            try await SearchArtistsHandler.handle(services: services, options: options, query: query, limit: limit, offset: offset)
        } catch {
