...
public struct SearchMusicVideosCommand: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "music-videos",
        abstract: "Search for music videos in the Apple Music catalog"
    )
    ...
    public func run() async throws {
        ...
        try await SearchMusicVideosHandler.handle(services: services, options: options, query: query, limit: limit, offset: offset)
    }
    public init() {}
}
