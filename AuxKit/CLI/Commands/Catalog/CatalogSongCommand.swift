...
public struct CatalogSongCommand: AsyncParsableCommand {
    ...
    @Option(name: .long, help: "Relationships to include (e.g. artists, albums)")
    var include: [String] = []
    ...
    public func run() async throws {
        ...
        do {
            ...
            try await CatalogSongHandler.handle(services: services, options: options, id: id, include: include.isEmpty ? nil : include)
        } catch {
