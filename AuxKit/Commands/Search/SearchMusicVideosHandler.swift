//
//  SearchMusicVideosHandler.swift
//  AuxKit
//
...
/// Handler for searching music videos in the Apple Music catalog.
public struct SearchMusicVideosHandler {
    public static func handle(
        ...
        let results = try await services.catalog.searchMusicVideos(query: query, limit: limit, offset: offset)
