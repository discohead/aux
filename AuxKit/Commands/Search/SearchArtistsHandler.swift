...
/// Handler for searching artists in the Apple Music catalog.
public struct SearchArtistsHandler {
    public static func handle(
        ...
        let results = try await services.catalog.searchArtists(query: query, limit: limit, offset: offset)
