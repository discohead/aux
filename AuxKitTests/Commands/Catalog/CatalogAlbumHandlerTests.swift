//
//  CatalogAlbumHandlerTests.swift
//  AuxKitTests
//
...
struct CatalogAlbumHandlerTests {

    @Test func callsGetAlbum() async throws {
    ...
    @Test func returnsCorrectDTO() async throws {
        let container = ServiceContainer.mock()
        let mock = container.catalog as! MockMusicCatalogService
        mock.getAlbumResult = .success(.fixture(id: "42", title: "My Album"))
        ...
        #expect(json.contains("My Album"))
    }

    @Test func propagatesErrors() async throws {
        let container = ServiceContainer.mock()
        let mock = container.catalog as! MockMusicCatalogService
        mock.getAlbumResult = .failure(AuxError.notFound(message: "Album not found"))
